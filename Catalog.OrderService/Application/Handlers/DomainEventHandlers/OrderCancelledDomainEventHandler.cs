...
public sealed class OrderCancelledDomainEventHandler : INotificationHandler<OrderCancelledDomainEvent>
{
    ...
    public OrderCancelledDomainEventHandler(IBus bus, IUnitOfWork unitOfWork,
    ...
    public async Task Handle(OrderCancelledDomainEvent orderCreatedDomainEvent, CancellationToken cancellationToken)
    {
        ...
        await _bus.Publish(new OrderCancelledEvent(order.ConvertToDto()));
    }
}