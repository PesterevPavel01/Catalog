...
public sealed class OrderRejectedDomainEventHandler : INotificationHandler<OrderRejectedDomainEvent>
{
    private readonly IBus _bus;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ITelegramService _telegramService;

    public OrderRejectedDomainEventHandler(IBus bus, IUnitOfWork unitOfWork,
    ...
    public async Task Handle(OrderRejectedDomainEvent orderRejectedDomainEvent, CancellationToken cancellationToken)
    {
        ...
        await _bus.Publish(new OrderRejectedEvent(order.ConvertToDto()));
    }
}