...
public class OrderInProductionDomainEventHandler : INotificationHandler<OrderInProductionDomainEvent>
{
    private readonly IBus _bus;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ITelegramService _telegramService;

    public OrderInProductionDomainEventHandler(IBus bus, IUnitOfWork unitOfWork,
    ...
    public async Task Handle(OrderInProductionDomainEvent orderInProductionDomainEvent, CancellationToken cancellationToken)
    {
        var order = await _unitOfWork.GetRepository<Order>()
            .GetFirstOrDefaultAsync(
                predicate: x => x.Id == orderInProductionDomainEvent.OrderId,
